...
const CoachDashboard = () => {
  ...
  const welcomeMessage = isCreator
    ? 'Welcome back, Creator! Manage your team efficiently with our comprehensive tools.'
    : 'Welcome back, Coach! Manage your team efficiently with our comprehensive tools.';
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 lg:gap-8">
              <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-8 shadow-xl hover:shadow-2xl hover:scale-105 transition duration-300 cursor-pointer group">
                ...
                <button
                  ...
                  className="bg-white text-blue-600 px-6 py-3 rounded-lg hover:bg-gray-100 transition duration-200 font-semibold shadow-lg"
                >
                  View Players
                </button>
              </div>
              <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-8 shadow-xl hover:shadow-2xl hover:scale-105 transition duration-300 cursor-pointer group">
                ...
                <button
                  ...
                  className="bg-white text-orange-600 px-6 py-3 rounded-lg hover:bg-gray-100 transition duration-200 font-semibold shadow-lg"
                >
                  View Attendance
                </button>
              </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900">
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="flex-1 p-4 lg:p-8 overflow-y-auto bg-gradient-to-br from-gray-50 to-blue-50">{renderContent()}</div>
      </div>
    </div>
  );
};
